    ...
    <div className="grid about__container">
       ...
       <aside>
            ...
            <div className="about__text">
                ...
                <p>
                רועי עוסק באילוף כלבים והכשרת כלבי ביטחון כבר למעלה מ 5 שנים עם מאות לקוחות מרוצים ,ואף הכשיר ומכר כלבים לחברות אבטחה למטרת הרחת חומרי נפץ ,אמל"ח וסמים. </p> 
